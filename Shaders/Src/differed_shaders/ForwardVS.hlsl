...
StructuredBuffer<InstanceInfo> InstanceSB : register(t1);
...
VsOutput main(VSInput input)
{
    ...
    matrix worldMatrix = DrawInfoCB.worldTransform;
    if (DrawInfoCB.IsInstanced)
    {
        worldMatrix = InstanceSB[input.InstanceID].Transform;
    }
