...
Dx12Core::UploadBuffer::UploadBuffer(RefCountPtr<ID3D12Device2> device, size_t pageSize)
	: m_device(device)
	,  m_pageSize(pageSize)
{
}

UploadBuffer::Allocation Dx12Core::UploadBuffer::Allocate(size_t sizeInBytes, size_t alignment)
{
...
void Dx12Core::UploadBuffer::Reset()
{
...
std::shared_ptr<UploadBuffer::Page> Dx12Core::UploadBuffer::RequestPage()
{
...
Dx12Core::UploadBuffer::Page::Page(RefCountPtr<ID3D12Device2> device, size_t sizeInBytes)
	: m_cpuPtr(nullptr)
	, m_offset(0)
...
Dx12Core::UploadBuffer::Page::~Page()
{
...
bool Dx12Core::UploadBuffer::Page::HasSpace(size_t sizeInBytes, size_t alignment) const
{
...
UploadBuffer::Allocation Dx12Core::UploadBuffer::Page::Allocate(size_t sizeInBytes, size_t alignment)
{
...
void Dx12Core::UploadBuffer::Page::Reset()
{
	this->m_offset = 0;
}
